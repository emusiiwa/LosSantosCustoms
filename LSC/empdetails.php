        ...
        <form action="employees.php" method="POST" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <div class="account-details">
                    ...
                    <div>
                        ...
                        <input type="email" name="mail" id="mail" placeholder="example@you.com" value="<?php echo $mail ?>" disabled>
                    </div>
                    <div>
            ...
            <fieldset>
                ...
                <div class="terms-mailing">
                    <div class="checkbox">
                        <input type="checkbox" name="checkbox" disabled><span>The above details are
                            used
            ...
            <input type="submit" name="update" value="BACK TO USERS" class="button1" style="width:100%">
        </form>
